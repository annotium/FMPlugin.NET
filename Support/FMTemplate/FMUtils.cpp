...
fmx::errcode RegisterExternalFunction( FMX_UInt16 iFunctionID, FMX_Int16 iMinArgs, FMX_Int16 iMaxArgs, FMX_UInt32 iTypeFlags, fmx::ExtPluginType iFunctionPtr)
{
    ...
    err = RegisterExternalFunctionEx( iFunctionID, name, prototype, iMinArgs, iMaxArgs, iTypeFlags, iFunctionPtr );
    
    return err;
}

fmx::errcode RegisterExternalFunctionEx( FMX_UInt16 iFunctionID, fmx::TextAutoPtr name, fmx::TextAutoPtr prototype, FMX_Int16 iMinArgs,
                                       FMX_Int16 iMaxArgs, FMX_UInt32 iTypeFlags, fmx::ExtPluginType iFunctionPtr )
{
    fmx::QuadCharAutoPtr    pluginID(PLUGIN_ID_STRING[0], PLUGIN_ID_STRING[1], PLUGIN_ID_STRING[2], PLUGIN_ID_STRING[3]);
    fmx::errcode            err;
